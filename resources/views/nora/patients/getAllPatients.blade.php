                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="row">
                                        ...
                                        <form action="{{ route('noraScheduler', ['patientNoraEnccode' => $pat->enccode]) }}" method="POST">
                                            @csrf
                                            <input name="patientNoraEnccode" type="hidden" value="patientNoraEnccode" hidden>
                ...
                if (data.length > 0) {
                    ...
                    data.forEach(element => {
                        template += '<tr>' +
                            ...
                            '<td>' + element.findx + '</td>' +
                            '<td>' +
                            '<form action="/noraPatientdetails" method="POST" enctype="multipart/form-data">' +
                            '@csrf' +
