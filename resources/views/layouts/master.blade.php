...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @if(App\Http\Controllers\LoggedUser::user_role()==1 || App\Http\Controllers\LoggedUser::user_role()== 3 || App\Http\Controllers\LoggedUser::user_role()== 4)
        ...
        <footer class="main-footer" align="right">
            <span><b>NOTE:</b> For assistance, please call IHOMS at local 202 </span>
        </footer>
    </div>
    <!-- ./wrapper -->
