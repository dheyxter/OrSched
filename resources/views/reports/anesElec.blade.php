...
<div class="row mt-3 d-print-none form-inline">
    <div class="col-6">
        <h2 class=""><i class="fas fa-file-alt"></i> Elective Surgery Schedule</h2>
    </div>
</div>
...
<div class="row">
    <div class="col-3">
        <form action="{{route('anesElecFilter')}}" method="POST">
            @csrf
            <div class="card mt-5">
    ...
    <div class="col-9">
        <div class="col-12" align="right">
            ...
            @if(empty($dateTo))
                <a href="#" id="btnPrint" hidden class="mb-2 printMe6 btn btn-outline-primary" type="button"><i class="fas fa-search"></i> Print Preview</a>
            @else 
                <a href="#" id="btnPrint" class="mb-2 printMe6 btn btn-outline-primary" type="button"><i class="fas fa-search"></i> Print Preview</a>
            @endif
        </div>
        <div class="w-100"></div>
        @if(count($total)>0)
...
<script type="text/javascript">
    ...
    //     childWin = window.open("/print/anesElec", "searchPatient", "height=" + h + ", width=" + w +
